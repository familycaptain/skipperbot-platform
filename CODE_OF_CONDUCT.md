...
discussions, any official communication channels) and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers at `conduct@CHANGE_ME`. All complaints will be
reviewed and investigated promptly and fairly. The maintainers will respect
