...
ONBOARDING_AGENDA = [
    {
        ...
        "desc": (
            ...
            "Capture RELATIONSHIP + ROLE ONLY — do NOT ask for, require, or record AGES (the "
            "platform doesn't use them): 'child'/'kid' denotes a ROLE, not an age, so never "
            "ask how old anyone is or for an approximate age. "
