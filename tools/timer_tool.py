"""
Timer Tool — Set, list, and cancel short-duration timers.

Timers are in-memory countdowns that fire a notification to the requesting
user when they expire. Use them for sub-minute and short (< 1 hour)
countdowns. For anything tied to a wall-clock time or longer than ~30
minutes, use set_reminder instead.
"""

import os
import sys

# Ensure project root is importable when this module is loaded standalone
